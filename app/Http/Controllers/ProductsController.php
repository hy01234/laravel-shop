...
class ProductsController extends Controller
{
    ...
    public function category_tree(CategoryService $categoryService)
    {
        $categoryTree = $categoryService->getCategoryTree();

        $list = $this->objtoarr($categoryTree);
//dd(json_encode($categoryTree));

        return response()->json(['list' => array_values($list)]);
    }
