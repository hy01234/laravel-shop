...
class OrderService
{
    ...
    public function refundOrder(Order $order)
    {
        ...
        switch ($order->payment_method) {
            ...
            case 'alipay':
                $refundNo = Order::getAvailableRefundNo();
                $ret = $this->alipay_refund($order->no, $order->total_amount, $refundNo);
                if ($ret->sub_code) {
                    $extra = $order->extra;
    ...
    public function alipay_refund($out_trade_no, $refund_amount, $out_request_no)
    {
        ...
        var_dump($ret);
        if ($ret->sub_code == "aop.ACQ.SYSTEM_ERROR"){
            $this->alipay_refund($out_trade_no, $refund_amount, $out_request_no);
        }else{
            return $ret;
        }
